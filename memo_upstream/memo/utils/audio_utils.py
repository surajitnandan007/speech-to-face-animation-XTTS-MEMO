...
def preprocess_audio(
    ...
    if vocal_separator_model is not None and Separator is not None:
    ...
    elif vocal_separator_model is not None:
        logger.warning("audio-separator is not installed. Continuing without vocal separation.")
